...
const RAW: Record<Locale, Raw> = {
  en: {
    ...
    musicIntro: "A small sample of my mixing work. Pop and R&B, mixed in Logic Pro and FL Studio. Press play.",
    playLabel: "Play",
  ...
  fr: {
    ...
    musicIntro: "Un petit aperçu de mon travail de mixage. Pop et R&B, mixés sur Logic Pro et FL Studio. Appuyez sur lecture.",
    playLabel: "Lecture",
  ...
  es: {
    ...
    musicIntro: "Una pequeña muestra de mi trabajo de mezcla. Pop y R&B, mezclados en Logic Pro y FL Studio. Dale al play.",
  ...
  pt: {
    ...
    musicIntro: "Uma pequena amostra do meu trabalho de mixagem. Pop e R&B, mixados no Logic Pro e FL Studio. Aperte o play.",
    playLabel: "Tocar",
  ...
  de: {
    ...
    musicIntro: "Ein kleiner Auszug meiner Mixing-Arbeit. Pop und R&B, gemischt in Logic Pro und FL Studio. Drück auf Play.",
    playLabel: "Abspielen",
  ...
  it: {
    ...
    musicIntro: "Un piccolo assaggio del mio lavoro di missaggio. Pop e R&B, mixati in Logic Pro e FL Studio. Premi play.",
    playLabel: "Riproduci",
    capLabel: "Competenze",
    capTitle: "Cosa offro",
  ...
  zh: {
    ...
    musicLabel: "音乐",
    musicTitle: "我的混音作品",
    musicIntro: "我混音作品的一小部分。流行与 R&B，使用 Logic Pro 和 FL Studio 混音。点击播放。",
    playLabel: "播放",
    capLabel: "能力",
    capTitle: "我的能力",
    coreLabel: "核心技能",
  ...
  ja: {
    ...
    musicLabel: "音楽",
    musicTitle: "制作したミックス",
    musicIntro: "私のミキシング作品のほんの一部です。ポップと R&B を Logic Pro と FL Studio でミックスしました。再生してみてください。",
    playLabel: "再生",
    capLabel: "スキル",
    capTitle: "私の強み",
    coreLabel: "主なスキル",
  ...
  ko: {
    ...
    musicLabel: "음악",
    musicTitle: "내가 만든 믹스",
    musicIntro: "제 믹싱 작업의 일부입니다. 팝과 R&B를 Logic Pro와 FL Studio로 믹싱했습니다. 재생해 보세요.",
    playLabel: "재생",
    capLabel: "역량",
    capTitle: "내가 가진 역량",
    coreLabel: "핵심 역량",
  ...
  ru: {
    ...
    musicIntro: "Небольшая подборка моей работы по сведению. Поп и R&B, сведено в Logic Pro и FL Studio. Нажмите воспроизведение.",
    playLabel: "Слушать",
    capLabel: "Навыки",
  ...
  ar: {
    ...
    musicIntro: "نموذج صغير من عملي في المزج. بوب و R&B، مُمزَجة في Logic Pro وFL Studio. اضغط للتشغيل.",
    playLabel: "تشغيل",
    capLabel: "المهارات",
  ...
  hi: {
    ...
    musicIntro: "मेरे मिक्सिंग काम का एक छोटा नमूना। पॉप और R&B, Logic Pro और FL Studio में मिक्स किए गए। प्ले दबाएँ।",
    playLabel: "चलाएँ",
    capLabel: "योग्यताएँ",
